  ...
  <table>
    <tr>
      <td align="center" width="140">
        <div style="background: linear-gradient(135deg, rgba(102,126,234,0.15), rgba(118,75,162,0.15)); border-radius: 12px; padding: 10px 8px; border: 1px solid rgba(102,126,234,0.2);">
  ...
  <table>
    <tr>
      <td align="center" width="25%">
        <div style="background: linear-gradient(135deg, rgba(102,126,234,0.06), rgba(6,182,212,0.04)); border-radius: 16px; padding: 18px 12px; border: 1px solid rgba(102,126,234,0.1);">
          <img loading="lazy" src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Graduation%20Cap.png" alt="Grad" width="30" height="30">
          <br>
          <b style="color: #667eea;">Education</b>
          <br>
          <span style="font-size: 13px;">B.Tech CSE</span>
        </div>
      </td>
      <td align="center" width="25%">
        <div style="background: linear-gradient(135deg, rgba(102,126,234,0.06), rgba(118,75,162,0.04)); border-radius: 16px; padding: 18px 12px; border: 1px solid rgba(102,126,234,0.1);">
          <img loading="lazy" src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Travel%20and%20places/Globe%20Showing%20Asia-Australia.png" alt="Globe" width="30" height="30">
          <br>
          <b style="color: #764ba2;">Open Source</b>
          <br>
          <span style="font-size: 13px;">Active Contributor</span>
        </div>
      </td>
      <td align="center" width="25%">
        <div style="background: linear-gradient(135deg, rgba(6,182,212,0.06), rgba(102,126,234,0.04)); border-radius: 16px; padding: 18px 12px; border: 1px solid rgba(6,182,212,0.1);">
          <img loading="lazy" src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Laptop.png" alt="Laptop" width="30" height="30">
          <br>
          <b style="color: #06b6d4;">Focus</b>
          <br>
          <span style="font-size: 13px;">Scalable Systems</span>
        </div>
      </td>
      <td align="center" width="25%">
        <div style="background: linear-gradient(135deg, rgba(118,75,162,0.06), rgba(102,126,234,0.04)); border-radius: 16px; padding: 18px 12px; border: 1px solid rgba(118,75,162,0.1);">
          <img loading="lazy" src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Travel%20and%20places/Rocket.png" alt="Rocket" width="30" height="30">
          <br>
          <b style="color: #764ba2;">Mission</b>
          <br>
          <span style="font-size: 13px;">Build & Learn</span>
        </div>
      </td>
    </tr>
  </table>
    ...
    <tr>
      <td valign="top" width="33%">
        <div style="background: linear-gradient(135deg, rgba(102,126,234,0.06), rgba(118,75,162,0.04)); border-radius: 16px; padding: 20px 15px; border: 1px solid rgba(102,126,234,0.12); margin: 5px;">
          <h4 align="center" style="color: #667eea; margin: 0 0 12px 0;">Languages</h4>
          <div align="center">
      ...
      <td valign="top" width="33%">
        <div style="background: linear-gradient(135deg, rgba(6,182,212,0.06), rgba(102,126,234,0.04)); border-radius: 16px; padding: 20px 15px; border: 1px solid rgba(6,182,212,0.12); margin: 5px;">
      ...
      <td valign="top" width="33%">
        <div style="background: linear-gradient(135deg, rgba(118,75,162,0.06), rgba(102,126,234,0.04)); border-radius: 16px; padding: 20px 15px; border: 1px solid rgba(102,126,234,0.12); margin: 5px;">
          ...
          <div align="center">
            ...
            <img src="https://img.shields.io/badge/Prometheus-E6522C?style=for-the-badge&logo=prometheussoftware&logoColor=white" alt="Prometheus">
  ...
  <table>
    <tr>
      <td width="50%" valign="top">
        <div style="background: linear-gradient(135deg, rgba(102,126,234,0.08), rgba(118,75,162,0.06)); border-radius: 18px; padding: 25px 20px; border: 1px solid rgba(102,126,234,0.15); min-height: 220px;">
          <div align="center">
            <img loading="lazy" src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Books.png" alt="Books" width="40" height="40">
            <br><br>
      ...
      <td width="50%" valign="top">
        <div style="background: linear-gradient(135deg, rgba(118,75,162,0.08), rgba(102,126,234,0.06)); border-radius: 18px; padding: 25px 20px; border: 1px solid rgba(102,126,234,0.15); min-height: 220px;">
          <div align="center">
    ...
    <tr>
      <td width="50%" valign="top">
        <div style="background: linear-gradient(135deg, rgba(6,182,212,0.08), rgba(102,126,234,0.06)); border-radius: 18px; padding: 25px 20px; border: 1px solid rgba(6,182,212,0.15); min-height: 220px;">
          <div align="center">
      ...
      <td width="50%" valign="top">
        <div style="background: linear-gradient(135deg, rgba(102,126,234,0.08), rgba(6,182,212,0.06)); border-radius: 18px; padding: 25px 20px; border: 1px solid rgba(102,126,234,0.15); min-height: 220px;">
          <div align="center">
  ...
  <table>
    <tr>
      <td width="33%" align="center">
        <div style="background: linear-gradient(135deg, rgba(102,126,234,0.08), rgba(118,75,162,0.06)); border-radius: 16px; padding: 20px 15px; border: 1px solid rgba(102,126,234,0.12);">
      ...
      <td width="33%" align="center">
        <div style="background: linear-gradient(135deg, rgba(118,75,162,0.08), rgba(102,126,234,0.06)); border-radius: 16px; padding: 20px 15px; border: 1px solid rgba(102,126,234,0.12);">
      ...
      <td width="33%" align="center">
        <div style="background: linear-gradient(135deg, rgba(6,182,212,0.08), rgba(102,126,234,0.06)); border-radius: 16px; padding: 20px 15px; border: 1px solid rgba(6,182,212,0.12);">
          <img loading="lazy" src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Spiral%20Notepad.png" alt="Portfolio" width="35" height="35">
          <br><br>
    ...
    <tr>
      <td width="33%" align="center">
        <div style="background: linear-gradient(135deg, rgba(102,126,234,0.08), rgba(118,75,162,0.06)); border-radius: 16px; padding: 20px 15px; border: 1px solid rgba(102,126,234,0.12);">
          <img loading="lazy" src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Gear.png" alt="DevOps" width="35" height="35">
          <br><br>
      ...
      <td width="33%" align="center">
        <div style="background: linear-gradient(135deg, rgba(118,75,162,0.08), rgba(102,126,234,0.06)); border-radius: 16px; padding: 20px 15px; border: 1px solid rgba(102,126,234,0.12);">
          <img loading="lazy" src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Link.png" alt="Network" width="35" height="35">
          <br><br>
      ...
      <td width="33%" align="center">
        <div style="background: linear-gradient(135deg, rgba(6,182,212,0.08), rgba(102,126,234,0.06)); border-radius: 16px; padding: 20px 15px; border: 1px solid rgba(6,182,212,0.12);">
          <img loading="lazy" src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Money%20Bag.png" alt="Freelance" width="35" height="35">
          <br><br>
